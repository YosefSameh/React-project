...
import DeleteIcon from '@mui/icons-material/Delete';
    ...
    return (
        ...
        <div className='rounded'  style={{display:"flex" , justifyContent:"center",alignItems:"center"}}>
        ...
        <Button style={{textAlign:"center", }} className='d-flex  bg-info text-black-50 justify-content-center align-items-center'  onClick={handelShowComments}  variant="contained"><ChatBubbleOutlineRoundedIcon/> <span className='ps-1'>5 </span></Button>
        </div>
        {/* Button Comments */}
        {/* Show Comments */}
        {showComments == true ? 
